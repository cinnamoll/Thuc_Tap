...
def financial_forecasting_node(state: FinancialReportState) -> dict:
    ...
    # Create temporary directory for forecasting data
    batch_id = state.get("batch_id", "unknown")
    temp_dir = os.path.join("temp_data", batch_id)
    os.makedirs(temp_dir, exist_ok=True)

    # Write forecasts to temporary file
    ...
    # Write prediction intervals to temporary file
    ...
    return {
        ...
        "prediction_intervals_path": intervals_file
    }